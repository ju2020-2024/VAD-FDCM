...
if __name__ == '__main__':
    ...
    pr_auc, pr_ap, out = test(test_loader, model, gt, args, False)
    x_input = out["x_input"]
    x_out = out["x_out"]
    ...
    visualize_tsne(
        x_input,
        labels=segment_gt,
        save_path="/home/stu2023/jj/project/vad2/ucf/result/Fig/tsne_x_input.png",
        title=''
    )
    ...
    visualize_tsne(
        x_out,
        labels=segment_gt,
        save_path="/home/stu2023/jj/project/vad2/ucf/result/Fig/tsne_x_out.png",
        title=''
    )
    ...
    visualize_tsne(
        h_common,
        labels=segment_gt,
        save_path="/home/stu2023/jj/project/vad2/ucf/result/Fig/tsne_h_common.png",
        title=''
    )
    ...
    visualize_tsne(
        h_specific,
        labels=segment_gt,
        save_path="/home/stu2023/jj/project/vad2/ucf/result/Fig/tsne_h_specific.png",
        title=''
    )
    visualize_tsne(
        x,
        labels=segment_gt,
        save_path="/home/stu2023/jj/project/vad2/ucf/result/Fig/tsne_x.png",
        title=''
    )
